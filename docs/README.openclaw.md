# Superharness — OpenClaw 安装指南

在 [OpenClaw](https://github.com/anthropics/openclaw) 中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills/* /your/project/skills/
```

或安装到全局（所有项目共享）：

```bash
cp -r superharness/plugins/superharness/skills/* ~/.openclaw/skills/
```
...
```json
{
  "skills": {
    "load": {
      "extraDirs": ["/path/to/superharness/plugins/superharness/skills"]
    }
  }
}
```
...
git pull
cp -r plugins/superharness/skills/* /your/project/skills/
```
