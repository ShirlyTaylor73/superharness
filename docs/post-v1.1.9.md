# 我用了一段时间 superpowers，我把它又改了一遍：superharness 二次增强版

> 适合发到：公众号 / 知乎 / 掘金 / V2EX
> 仓库：https://github.com/ShirlyTaylor73/superharness
...
## 所以我基于中文版的 superharness 重新做了一版

仓库地址：**https://github.com/ShirlyTaylor73/superharness**

我没有从头造轮子。中文翻译这一层 [`superharness`](https://github.com/obra/superpowers) 中文社区版已经做得很好，**直接解决了痛点 2**。我做的是在它的基础上**再叠加一层方法论增强**——专门针对剩下 3 个痛点。
...
完整链路全部跑通。两套独立的 plugin manifest（[`.claude-plugin/`](https://github.com/ShirlyTaylor73/superharness/tree/main/plugins/superharness/.claude-plugin) + [`.codex-plugin/`](https://github.com/ShirlyTaylor73/superharness/tree/main/plugins/superharness/.codex-plugin)）确保两边都能 `/plugin install` 一键到位，hooks 自动注入工作流状态上下文。
...
- 🔗 **仓库：** https://github.com/ShirlyTaylor73/superharness
- 📦 **19 个 active skills**（13 个翻译 + 6 个中国原创）
- 🤖 **17 款 AI 编程工具支持**
