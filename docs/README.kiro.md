# Superharness — Kiro 安装指南

在 [Kiro](https://kiro.dev)（Amazon AI IDE）中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills/* /your/project/.kiro/steering/
```
...
Superharness 的 SKILL.md 文件格式与 Kiro Steering 文件兼容（都是 Markdown + YAML frontmatter）。安装后，Kiro 会自动识别并加载 skills。
...
```markdown
---
description: 加载 Superharness skills 框架
alwaysApply: true
---

使用 .kiro/steering/ 目录下的 Superharness skills 来指导工作流程。
...
git pull
cp -r plugins/superharness/skills/* /your/project/.kiro/steering/
```
