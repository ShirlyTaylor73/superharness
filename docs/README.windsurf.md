# Superharness — Windsurf 安装指南

在 [Windsurf](https://codeium.com/windsurf) 中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills /your/project/.windsurf/skills
```

或全局安装：

```bash
cp -r superharness/plugins/superharness/skills ~/.windsurf/skills
```
