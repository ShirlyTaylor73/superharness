# Superharness — VS Code (Copilot) 安装指南

在 VS Code + GitHub Copilot 中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills/* /your/project/.github/superpowers/
```
...
本项目使用 Superharness skills 框架。开始新任务前，请参考以下方法论：
...
git pull
cp -r plugins/superharness/skills/* /your/project/.github/superpowers/
```
