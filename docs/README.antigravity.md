# Superharness — Antigravity 安装指南

在 [Google Antigravity](https://antigravity.google)（Google AI IDE）中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills/* /your/project/.antigravity/skills/
```
...
使用 .antigravity/ 目录下的 Superharness skills 来指导工作流程。
...
- 与 Superharness 的「派遣并行 Agent」skill 理念一致
...
git pull
cp -r plugins/superharness/skills/* /your/project/.antigravity/skills/
```
