# Superharness — Qwen Code 安装指南

在 [Qwen Code](https://tongyi.aliyun.com/qianwen) (通义灵码) 中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills /your/project/.qwen/skills
```
...
```bash
mkdir -p ~/.qwen/skills
cp -r superharness/plugins/superharness/skills/* ~/.qwen/skills/
```
