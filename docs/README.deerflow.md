# Superharness — DeerFlow 2.0 安装指南

在 [DeerFlow 2.0](https://github.com/bytedance/deer-flow)（字节跳动开源 SuperAgent）中使用 Superharness 的完整指南。
...
cp -r superharness/plugins/superharness/skills/* /your/deerflow-project/skills/custom/
```
...
Superharness 的 SKILL.md 文件格式与 DeerFlow 自定义 skills 完全兼容。安装后，DeerFlow 会自动发现并加载所有 skills。
...
cp -r superharness/plugins/superharness/skills/* $DEERFLOW_SKILLS_DIR/
```
...
git pull
cp -r plugins/superharness/skills/* /your/deerflow-project/skills/custom/
```
