...
**必需背景：** 在使用此技能前，你必须理解 superharness:test-driven-development。该技能定义了基本的红-绿-重构循环。本技能将 TDD 适配到文档编写中。
...
仅使用技能名称，带有明确的必需标记：
- ✅ 好的：`**必需子技能：** 使用 superharness:test-driven-development`
- ✅ 好的：`**必需背景：** 你必须理解 superharness:systematic-debugging`
...
**必需背景：** superharness:test-driven-development 技能解释了为什么这很重要。相同的原则适用于文档。
