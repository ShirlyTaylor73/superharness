...
1. **创建失败的测试用例**
   ...
   - 没有测试框架就写一次性测试脚本
   - 修复前必须先有测试
   - 使用 `superharness:test-driven-development` 技能来编写规范的失败测试
...
**相关技能：**
- **superharness:test-driven-development** - 用于创建失败测试用例（第四阶段，第 1 步）
- **superharness:verification** - 在宣称成功之前验证修复确实有效
...
| 调试 3 次以上都没修好 | 见上面"质疑架构"，可能也要 planning 重设计 |
