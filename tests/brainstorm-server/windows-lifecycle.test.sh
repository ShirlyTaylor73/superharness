...
# Requirements:
#   - Node.js in PATH
#   - Run from the repository root, or set SUPERHARNESS_ROOT
...
REPO_ROOT="${SUPERHARNESS_ROOT:-$(cd "$SCRIPT_DIR/../.." && pwd)}"
START_SCRIPT="$REPO_ROOT/plugins/superharness/skills/brainstorming/scripts/start-server.sh"
STOP_SCRIPT="$REPO_ROOT/plugins/superharness/skills/brainstorming/scripts/stop-server.sh"
SERVER_JS="$REPO_ROOT/plugins/superharness/skills/brainstorming/scripts/server.cjs"
