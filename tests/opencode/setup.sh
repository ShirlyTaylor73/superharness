...
mkdir -p "$HOME/.config/opencode/superharness/plugins"
cp -r "$REPO_ROOT/plugins/superharness" "$HOME/.config/opencode/superharness/plugins/superharness"

INSTALLED_PLUGIN_ROOT="$HOME/.config/opencode/superharness/plugins/superharness"
